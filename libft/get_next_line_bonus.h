...
/*   Updated: 2022/10/19 21:59:15 by nfukuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_split_and_store_text(char *str, size_t strlen,
						t_gnl_list *strage_p);
t_gnl_list				*ft_set_pointer(t_gnl_list **static_p, t_gnl_list **strage_p,
						int fd);

// in utils.c
char				*ft_strcat_and_free(char **s1, char **s2, size_t len);
char				*ft_delete_one_strage(t_gnl_list **static_p, t_gnl_list **strage_p);
